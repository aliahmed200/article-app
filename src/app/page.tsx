...
const HomePage = () => {
  return (
    <section className="my-20">
      <div className="flex sm:flex-col-reverse lg:flex-row lg:justify-between items-center">
        <div className="flex flex-col gap-3 sm:w-1/2 lg:w-4/5 sm:items-center lg:items-start">
          <h1 className="sm:text-2xl lg:text-5xl font-black leading-16">
            Explore Ideas.
            <br /> Expand Your Mind.
          </h1>
          <p className="sm:text lg:text-xl font-light">
